...
('MacBook Pro 14-inch',        'Apple',  'Computing',    '/images/macbook_pro_14.jpg',   'Laptop computer for development, design, and presentations.',  '14-inch Liquid Retina XDR, M3 Pro, 18GB RAM, 512GB SSD', 1),
('iPad Pro 12.9-inch',         'Apple',  'Computing',    '/images/ipad_pro_12.jpg',      'iPad for student presentations and media.',                    '12.9-inch Liquid Retina, M2, 256GB, Wi-Fi',              1),
('iPhone 15 Pro',              'Apple',  'Computing',    '/images/iphone_15_pro.jpg',    'iPhone for mobile documentation and communication.',           '6.1-inch Super Retina XDR, A17 Pro, 256GB',              2),
('Canon EOS 90D DSLR',         'Canon',  'Production',   '/images/canon_eos_90d.jpg',    'Digital camera for photography and video events.',             '32.5MP APS-C, 4K video, dual pixel autofocus',           2),
('Dell Projector P2418D',      'Dell',   'Production',   '/images/dell_p2418d.jpg',      'Full HD projector suitable for classrooms and events.',        '3200 lumens, HDMI, VGA, 1920x1080',                      3),
('Joby GorillaPod 5K Tripod',  'Joby',   'Production',   '/images/joby_gorillapod.jpg',  'Flexible tripod for cameras and smartphones.',                 'Max load 5kg, flexible legs, universal ball head',        3),
('Rode NT-USB Microphone',     'Rode',   'Audio',        '/images/rode_nt_usb.jpg',      'USB condenser microphone for recording and streaming.',        'Cardioid condenser, 16-bit/48kHz, USB-A',                4),
...
('Ugreen HDMI Cable 2m',       'Ugreen', 'Connectivity', '/images/ugreen_hdmi_2m.jpg',   'HDMI 2.1 cable for connecting displays and projectors.',       '2m, 8K@60Hz, 4K@120Hz, braided nylon',                   5),
('Anker PowerCore 20000mAh',   'Anker',  'Power',        '/images/anker_powercore.jpg',  'High-capacity power bank for charging devices on the go.',    '20000mAh, 2x USB-A + 1x USB-C, 22.5W fast charge',       5);
